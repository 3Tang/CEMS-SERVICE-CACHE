 ...
 */
public class BinaryJedisCluster extends JedisCluster implements JedisBase{
    ...
    public void close() {
    	 new JedisClusterCommand<String>(connectionHandler, timeout,
    		maxRedirections) {
    	      public String execute(Jedis connection) {

...
public class DeleteSQL {
	...
	public static String genDeleteSQL(Class<?> cls,String id) throws InstantiationException, IllegalAccessException{
    ...
    public static String genDeleteSQL(Class<?> cls,Number id) throws InstantiationException, IllegalAccessException{
    	StringBuffer sber=new StringBuffer();
    	String result=null;
    	SqlModel model = null;

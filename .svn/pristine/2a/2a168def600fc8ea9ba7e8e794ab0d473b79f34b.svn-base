...
public class RedisUtil {
	...
	private void init() {
		...
		try {
			...
			String filePath=prop.getPropertyFromCemsDat("path.redis.properties");
			...
			log.info("redis type:"+type+"hosts:"+hosts+"ports"+ports);
			...
			if(SINGLE.equals(type)){
				...
				jc=new SingleJedis(config, hosts,Integer.parseInt(ports));
